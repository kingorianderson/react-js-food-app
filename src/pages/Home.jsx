            ...
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <p>
                  ...
                  odio, quod asperiores delectus quis quo.
                </p>

                <div className="hero__btns d-flex align-items-center gap-5 mt-4">
                  <button className="order__btn d-flex align-item-center">
                    Order Now
                ...
                <div className="hero__service d-flex align-items-center gap-5 mt-5">
                  <p className="d-flex align-items-center gap-2">
                    <span>
                      <FaShippingFast /> No shipping charges
                    </span>
                  </p>
                  <p className="d-flex align-items-center gap-2">
                    <span>
                      <BsShieldCheck /> 100% secure checkout
                    </span>
                  </p>
                </div>
              </div>
